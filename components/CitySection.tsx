        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <img 
              ...
              alt="Campinas, principal mercado para aluguel de carro para aplicativo" 
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-base text-via-blue font-bold tracking-wide uppercase mb-2">Campinas e região</h2>
            <h3 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-6">
              Aluguel de carros para aplicativo em Campinas com alta demanda o ano inteiro
            </h3>
            <p className="text-lg text-slate-600 mb-6">
              Conhecemos cada canto da cidade. Nossos carros são ideais para motoristas de aplicativo que rodam
              nas avenidas movimentadas de Campinas, como a <strong>Norte-Sul</strong> e a <strong>Barão de Itapura</strong>,
              além das corridas longas para o <strong>Aeroporto de Viracopos</strong>.
            </p>
